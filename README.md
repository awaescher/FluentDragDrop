...
```
<sup><a href='/src/FluentDragDropExample/TestForm.cs#L33-L52' title='File snippet `immediateusage` was extracted from'>snippet source</a> | <a href='#snippet-immediateusage' title='Navigate to start of snippet `immediateusage`'>anchor</a></sup>
<!-- endSnippet -->
...
```
<sup><a href='/src/FluentDragDropExample/TestForm.cs#L81-L95' title='File snippet `delayedusage` was extracted from'>snippet source</a> | <a href='#snippet-delayedusage' title='Navigate to start of snippet `delayedusage`'>anchor</a></sup>
<!-- endSnippet -->
